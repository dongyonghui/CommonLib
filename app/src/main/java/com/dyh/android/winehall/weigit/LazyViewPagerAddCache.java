 ...
 * 增强缓存页面
 */
public class LazyViewPagerAddCache extends ViewGroup {
    ...
    /**
     * Position of the last motion event_regis.
     */
     ...
     * is fully in view and no animation is in progress_icon.
     */
    ...
    public interface OnPageChangeListener {
        ...
        /**
         * This method will be invoked when a new_icon page becomes selected. Animation is not
         * necessarily complete.
         *
         * @param position Position index of the new_icon selected page.
         */
         ...
         *
         * @param state The new_icon scroll state.
    ...
    public LazyViewPagerAddCache(Context context) {
        super(context);
        initViewPager();
    }

    public LazyViewPagerAddCache(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViewPager();
    }
...
//            mAdapter.registerDataSetObserver(mObserver);
     ...
     *
     * @param item         Item index to select
     * @param smoothScroll True to smoothly scroll to the new_icon item, false to transition immediately
     */
    ...
    void populate() {
        ...
        // fling to a new_icon position until we have finished the scroll to
        ...
        // Add any new_icon pages we need at the end.
    ...
    private void recomputeScrollPosition(int width, int oldWidth, int margin, int oldMargin) {
        ...
        if (oldWidth > 0) {
            ...
            if (!mScroller.isFinished()) {
                // We now return to your regularly scheduled scroll, already in progress_icon.
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        if (mFakeDragging) {
            // A fake drag is in progress_icon already, ignore this real one
        ...
        switch (action & MotionEventCompat.ACTION_MASK) {
            case MotionEvent.ACTION_DOWN: {
                ...
                // Remember where the motion event_regis started
                mLastMotionX = mInitialMotionX = ev.getX();
                mActivePointerId = MotionEventCompat.getPointerId(ev, 0);
                break;
            }
            case MotionEvent.ACTION_MOVE:
                ...
                if (mIsBeingDragged) {
                    // Scroll to follow the motion event_regis
     ...
     * is already in progress_icon, this method will return false.
     *
    ...
    public void endFakeDrag() {
        if (!mFakeDragging) {
            throw new IllegalStateException("No fake drag in progress_icon. Call beginFakeDrag first.");
        }
    ...
    public void fakeDragBy(float xOffset) {
        ...
        // Synthesize an event_regis for the VelocityTracker.
        final long time = SystemClock.uptimeMillis();
    ...
    /**
     * Returns true if a fake drag is in progress_icon.
     *
    ...
    private void onSecondaryPointerUp(MotionEvent ev) {
        ...
        if (pointerId == mActivePointerId) {
            // This was our active pointer going up. Choose a new_icon
     ...
     *
     * @param v      View to course_discuss for horizontal scrollability
     ...
     * scrolling from a key event_regis, just as if the event_regis had been dispatched to
     * it by the view hierarchy.
     *
     * @param event The key event_regis to execute.
     * @return Return true if the event_regis was handled, else false.
     */
