 ...
 * 秒杀时间管理
 */
public class CityTimeManagePresenter extends MVPPresenter<IDefaultManageView<TimeItemBean>> {

    private final BaseHttpPageRequestBean requestBean = new BaseHttpPageRequestBean();


    public CityTimeManagePresenter( IDefaultManageView<TimeItemBean> view) {
        super(view);
    }
    ...
    public void deleteNotice(TimeItemBean itemBean) {
        ...
        new MyAppDialog(getActivity())
                ...
                .setMessage(getActivity().getString(R.string.formatString_deleteCityTime, itemBean.getEndTimeStr(), itemBean.getSendTimeStr()))
                ...
                .setPositive(resources.getString(R.string.delete), new OnDialogClickListener() {
                    ...
                    public void onDialogButtonClicked(MyAppDialog dialog) {
                        ...
                        EasyHttp.post(ApiPathConstants.DELETE_CITY_TIME)
    ...
    private void loadListData(BaseHttpPageRequestBean requestBean) {
        EasyHttp.post(ApiPathConstants.GET_CITY_TIME_LIST)
                .upObject(requestBean)
