...
import com.dyh.commonlib.presenter.AddOrEditCityTimePresenter;
 ...
 * 新建或编辑城市时间
 */
public class AddOrEditCityTimeActivity extends BaseMVPActivity implements IDefaultOptionView {
    ...
    private AddOrEditCityTimePresenter mPresenter = new AddOrEditCityTimePresenter(this);
    ...
    public int getLayoutId() {
        return R.layout.activity_add_or_edit_city_time;
    }
    ...
    private void showEditInfos() {
        ...
        mCommonTitleBar.getCenterTextView().setText(R.string.editCityTime);
        //设置选中的时间
