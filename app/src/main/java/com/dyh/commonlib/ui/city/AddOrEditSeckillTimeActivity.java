...
import com.dyh.commonlib.presenter.AddOrEditSeckillTimePresenter;
 ...
 * 新建或编辑秒杀时间
 */
public class AddOrEditSeckillTimeActivity extends BaseMVPActivity implements IDefaultOptionView {
    ...
    private AddOrEditSeckillTimePresenter mPresenter = new AddOrEditSeckillTimePresenter(this);
    ...
    public int getLayoutId() {
        return R.layout.activity_add_or_edit_seckill_time;
    }
    ...
    private void showEditInfos() {
        ...
        mCommonTitleBar.getCenterTextView().setText(R.string.editSeckillTime);
