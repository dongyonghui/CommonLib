...
import com.dyh.commonlib.presenter.BetterGoodsTimeManagePresenter;
 ...
 * 优选菜时间管理
 */
public class BetterGoodsTimeManageActivity extends BaseMVPActivity implements IDefaultManageView<TimeItemBean> {
    ...
    private BetterGoodsTimeManagePresenter mPresenter = new BetterGoodsTimeManagePresenter(this);
    ...
    public int getLayoutId() {
        return R.layout.activity_better_goods_time_manage;
    }
            ...
            public void onClicked(View v, int action, String extra) {
                switch (action) {
                    ...
                    case CommonTitleBar.ACTION_RIGHT_TEXT:
                        readyGoForResult(AddOrEditBetterGoodsTimeActivity.class, REQUEST_CODE_EDIT);
                        break;
                }
            }
        });
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                switch (view.getId()) {
                    case R.id.mEditTextView://编辑
                        ...
                        readyGoForResult(AddOrEditBetterGoodsTimeActivity.class, REQUEST_CODE_EDIT, bundle);
                        break;
