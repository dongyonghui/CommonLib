...
import com.dyh.commonlib.presenter.CityTimeManagePresenter;
...
public class CityTimeManageActivity extends BaseMVPActivity implements IDefaultManageView<TimeItemBean> {
    ...
    private CityTimeManagePresenter mPresenter = new CityTimeManagePresenter(this);
    ...
    public int getLayoutId() {
        return R.layout.activity_city_time_manage;
    }
            ...
            public void onClicked(View v, int action, String extra) {
                switch (action) {
                    ...
                    case CommonTitleBar.ACTION_RIGHT_TEXT:
                        readyGoForResult(AddOrEditCityTimeActivity.class, REQUEST_CODE_EDIT);
                        break;
                }
            }
        });
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                switch (view.getId()) {
                    case R.id.mEditTextView://编辑
                        ...
                        readyGoForResult(AddOrEditCityTimeActivity.class, REQUEST_CODE_EDIT, bundle);
                        break;
