 ...
 */
class MVPViewImpl(private val activity: Activity, private val pageMultipleStatusView: IPageMultipleStatusView) : MVPView {
    // 加载中的提示Dialog
    ...
    private val mMultipleStatusView: MultipleStatusView? by lazy {
        ...
        var tempView = MultipleStatusView.attach(activity, pageMultipleStatusView.getMultipleStatusContentViewId());
