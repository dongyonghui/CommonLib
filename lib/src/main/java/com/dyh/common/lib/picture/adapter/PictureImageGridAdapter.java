package com.dyh.common.lib.picture.adapter;
...
import com.dyh.common.lib.picture.tools.AnimUtils;
            ...
            if (media != null) {
                ...
                if (config.chooseMode == PictureMimeType.ofAll()) {
                    if (PictureMimeType.isHasImage(media.getMimeType())) {
                        // All videos are not ResponseOptional
                        ...
                        // All images are not ResponseOptional
