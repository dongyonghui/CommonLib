package com.dyh.common.lib.weigit.refresh_layout;
...
import com.dyh.common.lib.weigit.refresh_layout.api.DefaultRefreshHeaderCreator;
import com.dyh.common.lib.weigit.refresh_layout.api.DefaultRefreshInitializer;
import com.dyh.common.lib.weigit.refresh_layout.api.RefreshContent;
...
import com.dyh.common.lib.weigit.refresh_layout.api.RefreshInternal;
import com.dyh.common.lib.weigit.refresh_layout.api.RefreshKernel;
import com.dyh.common.lib.weigit.refresh_layout.api.RefreshLayout;
import com.dyh.common.lib.weigit.refresh_layout.api.ScrollBoundaryDecider;
import com.dyh.common.lib.weigit.refresh_layout.constant.DimensionStatus;
import com.dyh.common.lib.weigit.refresh_layout.constant.RefreshState;
import com.dyh.common.lib.weigit.refresh_layout.constant.SpinnerStyle;
import com.dyh.common.lib.weigit.refresh_layout.footer.BallPulseFooter;
import com.dyh.common.lib.weigit.refresh_layout.header.BezierRadarHeader;
import com.dyh.common.lib.weigit.refresh_layout.impl.RefreshContentWrapper;
import com.dyh.common.lib.weigit.refresh_layout.impl.RefreshFooterWrapper;
import com.dyh.common.lib.weigit.refresh_layout.impl.RefreshHeaderWrapper;
import com.dyh.common.lib.weigit.refresh_layout.listener.OnLoadMoreListener;
import com.dyh.common.lib.weigit.refresh_layout.listener.OnMultiPurposeListener;
import com.dyh.common.lib.weigit.refresh_layout.listener.OnRefreshListener;
import com.dyh.common.lib.weigit.refresh_layout.listener.OnRefreshLoadMoreListener;
import com.dyh.common.lib.weigit.refresh_layout.listener.OnStateChangedListener;
import com.dyh.common.lib.weigit.refresh_layout.util.SmartUtil;
...
import static com.dyh.common.lib.weigit.refresh_layout.util.SmartUtil.dp2px;
import static com.dyh.common.lib.weigit.refresh_layout.util.SmartUtil.fling;
import static com.dyh.common.lib.weigit.refresh_layout.util.SmartUtil.isContentView;
...
//            reboundAnimator.setDuration(20000);
    ...
    protected void moveSpinnerInfinitely(float spinner) {
         ...
         *
         * 2.XML关闭
         *          <com.inscloudtech.easyandroid.weigit.refresh_layout.SmartRefreshLayout
...
//    }
     ...
     * Recommended {@link com.dyh.common.lib.weigit.refresh_layout.listener.SimpleMultiPurposeListener}
     * 设置多功能监听器
     * 建议使用 {@link com.dyh.common.lib.weigit.refresh_layout.listener.SimpleMultiPurposeListener}
     ...
     * Recommended {@link com.dyh.common.lib.weigit.refresh_layout.impl.ScrollBoundaryDeciderAdapter}
     * 设置滚动边界判断器
     * 建议使用 {@link com.dyh.common.lib.weigit.refresh_layout.impl.ScrollBoundaryDeciderAdapter}
...
//                    break;
        ...
        /**
         * 移动滚动 Scroll
         * moveSpinner 的取名来自 谷歌官方的 {androidx.core.widget.SwipeRefreshLayout#moveSpinner(float)}
         * moveSpinner The name comes from {androidx.core.widget.SwipeRefreshLayout#moveSpinner(float)}
