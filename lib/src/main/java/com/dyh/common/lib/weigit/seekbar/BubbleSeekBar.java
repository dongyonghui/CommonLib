...
import static com.dyh.common.lib.weigit.seekbar.BubbleSeekBar.TextPosition.BELOW_SECTION_MARK;
import static com.dyh.common.lib.weigit.seekbar.BubbleSeekBar.TextPosition.BOTTOM_SIDES;
import static com.dyh.common.lib.weigit.seekbar.BubbleSeekBar.TextPosition.SIDES;
...
public class BubbleSeekBar extends View {
    ...
    public BubbleSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTrackColor = a.getColor(R.styleable.BubbleSeekBar_bsb_track_color,
                ContextCompat.getColor(context, R.color.general_titleColor));
