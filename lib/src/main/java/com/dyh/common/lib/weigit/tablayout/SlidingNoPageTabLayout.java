package com.dyh.common.lib.weigit.tablayout;
...
import com.dyh.common.lib.weigit.tablayout.utils.UnreadMsgUtils;
import com.dyh.common.lib.weigit.tablayout.widget.MsgView;
 ...
 */
public class SlidingNoPageTabLayout extends HorizontalScrollView {
    ...
    public SlidingNoPageTabLayout(Context context) {
        this(context, null, 0);
    }

    public SlidingNoPageTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SlidingNoPageTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
    ...
    private void calcIndicatorRect() {
        ...
        if (this.mCurrentTab < mTabCount - 1) {
            View nextTabView = mTabsContainer.getChildAt(this.mCurrentTab);
            float nextTabLeft = nextTabView.getLeft();
            float nextTabRight = nextTabView.getRight();

            left = left + (nextTabLeft - left);
            right = right + (nextTabRight - right);
            ...
            if (mIndicatorStyle == STYLE_NORMAL && mIndicatorWidthEqualTitle) {
                ...
                margin = margin + (nextMargin - margin);
            }
        }
        ...
        if (mIndicatorWidth < 0) {   //indicatorWidth小于0时,原jpardogo's PagerSlidingTabStrip
            ...
            if (this.mCurrentTab < mTabCount - 1) {
                View nextTab = mTabsContainer.getChildAt(this.mCurrentTab);
                indicatorLeft = indicatorLeft + (currentTabView.getWidth() / 2 + nextTab.getWidth() / 2);
            }
